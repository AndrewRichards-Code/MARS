...
namespace mars
{
	//Multiplies, or creates the composition of, a Mat2 input by a Mat2 transform.
	inline Mat2 Mat2Mat2Multiply(const Mat2& transform, const Mat2& input)
	{
	...
	//Operator Overload * , using the Mat2Mat2Multiply().
	//Multiplies, or creates the composition of, a Mat2 input by a Mat2 transform.
	inline Mat2 operator* (const Mat2& transform, const Mat2& input)
	{
		return Mat2Mat2Multiply(transform, input);
	}

	//Multiplies, or creates the composition of, a Mat3 input by a Mat3 transform.
	inline Mat3 Mat3Mat3Multiply(const Mat3& transform, const Mat3& input)
	{
	...
	//Operator Overload * , using the Mat3Mat3Multiply().
	//Multiplies, or creates the composition of, a Mat3 input by a Mat3 transform.
	inline Mat3 operator* (const Mat3& transform, const Mat3& input)
	{
		return Mat3Mat3Multiply(transform, input);
	}
	
	//Multiplies, or creates the composition of, a Mat4 input by a Mat4 transform.
	inline Mat4 Mat4Mat4Multiply(const Mat4& transform, const Mat4& input)
	{
	...
	//Operator Overload * , using the Mat4Mat4Multiply().
	//Multiplies, or creates the composition of, a Mat4 input by a Mat4 transform.
	inline Mat4 operator* (const Mat4& transform, const Mat4& input)
	{
		return Mat4Mat4Multiply(transform, input);
	}
}